...
export enum SkillExperienceType {
    PERSONAL = 'Personal',
...
export interface SkillItem {
    title: string;
    description?: string;
    experience: SkillExperienceItem[];
    tags: Tag[];
}

export const skillEntries: SkillItem[] = [
    {
        title: 'Angular',
        description: 'Angular is my go-to framework for front-end development. I have developed many projects in Angular and have a good understanding of the framework.',
        experience: [
            {
                title: 'Frankli',
    ...
    {
        title: 'CSS, SCSS',
        description: 'I consider myself fairly adept at CSS - I can easily replicate designs. I have a good understanding of browser compatibility and best practices.',
        experience: [
            {
                title: 'Frankli',
                type: SkillExperienceType.PROFESSIONAL,
